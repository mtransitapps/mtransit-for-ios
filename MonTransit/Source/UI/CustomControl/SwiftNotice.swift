...
extension UIViewController {
    ...
    func pleaseWaitWithText(iWaitingText:String) {
        SwiftNotice.wait(iWaitingText)
    }
...
class SwiftNotice: NSObject {
    ...
    static func wait(iWatingText:String = "", imageNames: Array<UIImage> = Array<UIImage>(), timeInterval: Int = 0) {

...
class DatePickerDialog: UIView {
    ...
    func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultDate: NSDate = NSDate(), datePickerMode: UIDatePickerMode = .DateAndTime, iMin:Int, iMax:Int, callback: DatePickerCallback) {
        ...
        self.datePicker.maximumDate = NSCalendar.currentCalendar().dateByAddingUnit(.Day, value: iMax, toDate: NSDate(), options: [])
        self.datePicker.minimumDate = NSCalendar.currentCalendar().dateByAddingUnit(.Day, value: iMin, toDate: NSDate(), options: [])

...
class StopsViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let wDate = wServiceDate.retrieveCurrentService()
         
        let wStopProvider = StopDataProviderHelper()
        if nil != mSelectedStation{
            mStopsList = wStopProvider.retrieveGtfsTime(wDate, iStationCodeId: Int(mSelectedStation.getStationCode())!)
            self.title = mSelectedStation.getStationTitle()
        }
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        {
            cell.mTimeBusLabel.text = mStopsList[indexPath.row].getTime()
        }
        return cell
    }

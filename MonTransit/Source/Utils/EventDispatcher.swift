...
extension UIControl: EventDispatcher
{
    override public func didMoveToSuperview()
    {
        ...
        addTarget(self, action: #selector(UIControl.changeHandler), forControlEvents: UIControlEvents.ValueChanged)
        addTarget(self, action: #selector(UIControl.tapHandler), forControlEvents: UIControlEvents.TouchDown)
    }
    ...
    override public func removeFromSuperview()
    {
        ...
        removeTarget(self, action: #selector(UIControl.changeHandler), forControlEvents: UIControlEvents.ValueChanged)
        removeTarget(self, action: #selector(UIControl.tapHandler), forControlEvents: UIControlEvents.TouchDown)
    }
